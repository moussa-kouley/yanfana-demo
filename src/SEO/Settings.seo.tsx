...
const SettingsSEO = () => {
  return (
    <Head>
      <title>Change Settings - ShareUp Pro</title>
      <meta property="og:title" content="Change Settings - ShareUp Pro" />
      <meta
        name="description"
      ...
      <meta name="twitter:title" content="Change Settings - ShareUp Pro" />
      <meta
