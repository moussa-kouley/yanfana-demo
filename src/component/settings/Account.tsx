  ...
  return (
    <>
      ...
      <p className="text-lg text-gray-700 dark:text-text-secondary mb-2">
        Your ShareUp Pro account administers these blogs: <span className="font-medium"> {session?.user.handle?.handle}.hashnode-t3.dev</span>
      </p>
      <p className="text-lg text-gray-700 dark:text-text-secondary mb-6">
        Your personal data will be deleted permanently when you delete your account on ShareUp Pro. This action is irreversible.
      </p>
